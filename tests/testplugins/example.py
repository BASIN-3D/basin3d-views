...
@basin3d_plugin
class ExampleSourcePlugin(DataSourcePluginPoint):
    title = 'Example Source Plugin'
    ...
    class DataSourceMeta:
        ...
        **Attributes:**
        ...
        id = 'Example'  # unique id for the datasource
        id_prefix = 'E'
        name = id  # Human Friendly Data Source Name


@basin3d_plugin_access(ExampleSourcePlugin, MeasurementTimeseriesTVPObservation, 'list')
...
@basin3d_plugin_access(ExampleSourcePlugin, MeasurementTimeseriesTVPObservation, 'get')
...
@basin3d_plugin_access(ExampleSourcePlugin, MonitoringFeature, 'list')
...
@basin3d_plugin_access(ExampleSourcePlugin, MonitoringFeature, 'get')
